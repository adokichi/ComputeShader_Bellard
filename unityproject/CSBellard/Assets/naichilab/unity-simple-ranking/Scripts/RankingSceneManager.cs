...
namespace naichilab
{
    public class RankingSceneManager : MonoBehaviour
    {
        ...
        private string ObjectID
        {
            ...
            get { return _objectid ?? (_objectid = SystemInfo.graphicsDeviceName.Replace(" ", "")); }
        ...
        private static RankingSceneManager instance;

        public static RankingSceneManager Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = (RankingSceneManager)FindObjectOfType(typeof(RankingSceneManager));

                    if (instance == null)
                    {
                        Debug.LogError(typeof(RankingSceneManager) + "is nothing");
                    }
                }
        ...
        public void _Start()
        {
            ...
            Debug.Log(BoardIdPlayerPrefsKey + "=" + ObjectID);
        ...
        IEnumerator GetHighScoreAndRankingBoard()
        {
            ...
            if (sendScoreButton.interactable == true)
                SendScore();
        }
        ...
        private IEnumerator SendScoreEnumerator()
        {
            ...
            Debug.Log("!!!!!");
            Debug.Log(_ncmbRecord.ObjectId);
            _ncmbRecord.ObjectId = "RTX2080Ti";
